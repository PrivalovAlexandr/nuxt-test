<template>
    <main>
        <AtomHeading level="1" class="text-20/140 text-center">Starships in StarWars university</AtomHeading>
        <StarshipsList class="mt-14" :starships="starships"/>
    </main>
</template>
...
const starships = ref(request.results)
</script>
